...
public class NineTailsWeightedGraph {
  ...
  private void constructGraph() {
    ...
    for (int i = 1; i <= NUM_CONFIGURATIONS; i++) {
      PriorityQueueInterface<WeightedEdge> parents = generateParents(i);
      // sort by weight
   ...
   * of flips
   *
   * @param confIndex index of the configuration to where a legal move is applied
   * @param position  position in the string of Hs and Ts where the legal move is applied
   ...
   * index
   *
   * @param index index of a configuration
   ...
   * of coin's Hs and Ts
   *
   * @param conf configuration of coin's of Hs and Ts
